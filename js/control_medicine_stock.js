function deleteMedicineStock(id) {
  ...
  if(confirmation) {
    ...
    xhttp.open("GET", "../ui/php/control_medicine_stock.php?action=delete&id=" + id, true);
    xhttp.send();
  }
}
...
function editMedicineStock(id) {
  ...
  xhttp.open("GET", "../ui/php/control_medicine_stock.php?action=edit&id=" + id, true);
  xhttp.send();
}
...
function updateMedicineStock(id) {
  ...
  if(!notNull(batch_id.value, "batch_id_error"))
    ...
    xhttp.open("GET", "../ui/php/control_medicine_stock.php?action=update&id=" + id + "&batch_id=" + batch_id.value + "&expiry_date=" + expiry_date.value + "&quantity=" + quantity.value + "&mrp=" + mrp.value + "&rate=" + rate.value, true);
    xhttp.send();
  }
}
...
function cancel() {
  ...
  xhttp.open("GET", "../ui/php/control_medicine_stock.php?action=cancel", true);
  xhttp.send();
}
...
function searchMedicineStock(text, tag) {
  ...
  xhttp.open("GET", "../ui/php/control_medicine_stock.php?action=search&text=" + text + "&tag=" + tag, true);
  xhttp.send();
}
