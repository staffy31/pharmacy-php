function deletePurchase(id) {
  ...
  if(confirmation) {
    ...
    xhttp.open("GET", "../ui/php/control_purchase.php?action=delete&id=" + id, true);
    xhttp.send();
  }
}
...
function editPurchase(id) {
  ...
  xhttp.open("GET", "../ui/php/control_purchase.php?action=edit&id=" + id, true);
  xhttp.send();
}
...
function updatePurchase(id) {
  ...
  if(!checkDate(invoice_date.value, 'date_error'))
    ...
    xhttp.open("GET", "../ui/php/control_purchase.php?action=update&id=" + id + "&suppliers_name=" + suppliers_name.value + "&invoice_date=" + invoice_date.value + "&grand_total=" + grand_total.value + "&payment_status=" + payment_status.value, true);
    xhttp.send();
  }
}
...
function cancel() {
  ...
  xhttp.open("GET", "../ui/php/control_purchase.php?action=cancel", true);
  xhttp.send();
}
...
function searchPurchase(text, tag) {
  ...
  xhttp.open("GET", "../ui/php/control_purchase.php?action=search&text=" + text + "&tag=" + tag, true);
  xhttp.send();
}
