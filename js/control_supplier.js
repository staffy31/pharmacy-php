function deleteSupplier(id) {
  ...
  if(confirmation) {
    ...
    xhttp.open("GET", "../ui/php/control_supplier.php?action=delete&id=" + id, true);
    xhttp.send();
  }
}
...
function editSupplier(id) {
  ...
  xhttp.open("GET", "../ui/php/control_supplier.php?action=edit&id=" + id, true);
  xhttp.send();
}
...
function updateSupplier(id) {
  ...
  if(!validateName(supplier_name.value, "name_error"))
    ...
    xhttp.open("GET", "../ui/php/control_supplier.php?action=update&id=" + id + "&name=" + supplier_name.value + "&email=" + supplier_email.value +"&contact_number=" + contact_number.value + "&address=" + supplier_address.value, true);
    xhttp.send();
  }
}
...
function cancel() {
  ...
  xhttp.open("GET", "../ui/php/control_supplier.php?action=cancel", true);
  xhttp.send();
}
...
function searchSupplier(text) {
  ...
  xhttp.open("GET", "../ui/php/control_supplier.php?action=search&text=" + text, true);
  xhttp.send();
}
