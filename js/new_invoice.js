...
function addRow() {
  ...
  xhttp.open("GET", "../ui/php/new_invoice.php?action=add_row&row_id=" + cls.value + "&row_number=" + addRow.counter, true);
  xhttp.send();
...
function getInvoiceNumber() {
  ...
  xhttp.open("GET", "../ui/php/new_invoice.php?action=current_invoice_number", true);
  xhttp.send();
}
...
function medicineOptions(text, id) {
  ...
  xhttp.open("GET", "../ui/php/new_invoice.php?action=medicine_list&text=" + text.trim(), true);
  xhttp.send();
}
...
function fill(name, field_name, column) {
  ...
  xhttp.open("GET", "../ui/php/new_invoice.php?action=fill&name=" + name + "&column=" + column, false);
  xhttp.send();
}
...
function checkAvailableQuantity(value, id) {
  ...
  xhttp.open("GET", "../ui/php/new_invoice.php?action=check_quantity&medicine_name=" + medicine_name, false);
  xhttp.send();
...
function isCustomer(name, contact_number) {
  ...
  xhttp.open("GET", "../ui/php/new_invoice.php?action=is_customer&name=" + name + "&contact_number=" + contact_number, false);
  xhttp.send();
...
function isInvoiceExist(invoice_number) {
  ...
  xhttp.open("GET", "../ui/php/new_invoice.php?action=is_invoice&invoice_number=" + invoice_number, false);
  xhttp.send();
  return xhttp.responseText;
}
...
function isMedicine(name) {
  ...
  xhttp.open("GET", "../ui/php/new_invoice.php?action=is_medicine&name=" + name, false);
  xhttp.send();
  //alert(xhttp.responseText);
  return xhttp.responseText;
}
...
function updateStock(name, batch_id, quantity) {
  ...
  xhttp.open("GET", "../ui/php/new_invoice.php?action=update_stock&name=" + name + "&batch_id=" + batch_id + "&quantity=" + quantity, true);
  xhttp.send();
}
...
function addSale(customers_name, customers_contact_number, invoice_number, medicine_name, batch_id, expiry_date, quantity, mrp, discount, total) {
  ...
  xhttp.open("GET", "../ui/php/new_invoice.php?action=add_sale&customers_name=" + customers_name + "&customers_contact_number=" + customers_contact_number + "&invoice_number=" + invoice_number + "&medicine_name=" + medicine_name + "&batch_id=" + batch_id + "&expiry_date=" + expiry_date +  "&quantity=" + quantity + "&mrp=" + mrp + "&discount=" + discount + "&total=" + total, true);
  xhttp.send();
}
...
function addNewInvoice(customers_name, customers_contact_number, invoice_date, total_amount, total_discount, net_total) {
  ...
  xhttp.open("GET", "../ui/php/new_invoice.php?action=add_new_invoice&customers_name=" + customers_name + "&customers_contact_number=" + customers_contact_number + "&invoice_date=" + invoice_date + "&total_amount=" + total_amount + "&total_discount=" + total_discount + "&net_total=" + net_total, true);
  xhttp.send();
}
