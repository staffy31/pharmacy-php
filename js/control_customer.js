function deleteCustomer(id) {
  ...
  if(confirmation) {
    ...
    xhttp.open("GET", "../ui/php/control_customer.php?action=delete&id=" + id, true);
    xhttp.send();
  }
}
...
function editCustomer(id) {
  ...
  xhttp.open("GET", "../ui/php/control_customer.php?action=edit&id=" + id, true);
  xhttp.send();
}
...
function updateCustomer(id) {
  ...
  if(!validateName(customer_name.value, "name_error"))
    ...
    xhttp.open("GET", "../ui/php/control_customer.php?action=update&id=" + id + "&name=" + customer_name.value + "&contact_number=" + contact_number.value + "&address=" + customer_address.value + "&doctor_name=" + doctor_name.value + "&doctor_address=" + doctor_address.value, true);
    xhttp.send();
  }
}
...
function cancel() {
  ...
  xhttp.open("GET", "../ui/php/control_customer.php?action=cancel", true);
  xhttp.send();
}
